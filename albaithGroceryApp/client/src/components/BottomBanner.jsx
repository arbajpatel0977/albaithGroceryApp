            ...
            <div className='absolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-16 md:pt-0 md:pr-24'>
                <div>
                    ...
                    {features.map((feature, index) => (
                        <div key={index} >
                            <img src={feature.icon} alt={feature.title} className='md:w-11 w-9 bg-green-700' />
                            <div> <h3 className='text-lg md:text-xl font-semibold text-green-700'>{feature.title}</h3>
                                <p className=' text-xs md:text-sm text-green-700'>{feature.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
