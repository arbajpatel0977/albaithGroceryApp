...
import { assets, fotterLinks } from '../assets/assets';
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10">
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
                Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">Al Baith .dev </a> All Right Reserved.
            </p>
        </div>
    );
